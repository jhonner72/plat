...
{
    public class ValidateBatchTransactionRequestToDipsNabChqScanPodMapper : IMapper<ValidateBatchTransactionRequest, IEnumerable<DipsNabChq>>
    {
        ...
        public IEnumerable<DipsNabChq> Map(ValidateBatchTransactionRequest input)
        {
            ...
            return input.voucher.Select(voucher => batchTransactionRequestMapHelper.CreateNewDipsNabChqForValidateTransactionRequest(
