namespace FujiXerox.Adapters.A2iaAdapter.OcrService
{
    public class Constants
    {
        ...
        public class ResultFields
        {
            ...
            public const string AltCreditBase = "documentTypeInfo.CaseCheck.custom.field.fieldTypeInfo.CaseAmount.result.";

            public const string Amount1 = "documentTypeInfo.CaseCheck.custom.fields[1].fieldTypeInfo.CaseAmount.result.amount";
            public const string AmountConfidence1 = "documentTypeInfo.CaseCheck.custom.fields[1].fieldTypeInfo.CaseAmount.result.score";

            public const string Amount = "documentTypeInfo.CaseCheck.Check.result.amount";
            public const string AmountConfidence = "documentTypeInfo.CaseCheck.Check.result.score";
