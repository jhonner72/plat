...
namespace Lombard.Adapters.DipsAdapter.IntegrationTests.Hooks
{
    ...
    /// </summary>
    [Binding]
    public class CorrectTransactionBus
    {
        private static readonly IAdvancedBus Bus;
        private static readonly ExchangePublisher<CorrectBatchTransactionRequest> RequestExchange;
        private static readonly IQueue Queue;

        private static readonly List<CorrectBatchTransactionRequest> Requests = new List<CorrectBatchTransactionRequest>();
        private static readonly List<CorrectBatchTransactionResponse> Responses = new List<CorrectBatchTransactionResponse>();
        ...
        private CorrectTransactionBus()
        {
        }

        [BeforeScenario("CorrectTransaction")]
        public static void BeforeCorrecttransactionScenario()
        {
            Requests.Clear();
            Responses.Clear();
        ...
        public static async Task<CorrectBatchTransactionResponse> GetSingleResponseAsync(int timeOutSeconds)
        {
