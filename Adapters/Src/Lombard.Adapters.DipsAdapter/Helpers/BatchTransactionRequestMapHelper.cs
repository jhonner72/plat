        ...
        public DipsNabChq CreateNewDipsNabChqForCorrectTransactionRequest(
            ...
            string batchAuxDom)
         {
            ...
            var output = new DipsNabChq
            {
                ...
                isGeneratedVoucher = RequestHelper.ConvertBoolToIntString(isGeneratedVoucher.Value),
                ...
                alt_acc_num = IgnoreString(10),
                alt_bsb_num = IgnoreString(6),
                alt_ead = IgnoreString(15),
                alt_ser_num = IgnoreString(9),
                alt_trancode = IgnoreString(3)
            };
            return output;
        }
