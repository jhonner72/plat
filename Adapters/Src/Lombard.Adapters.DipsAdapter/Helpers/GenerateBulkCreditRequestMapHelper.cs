...
{
    public class GenerateBulkCreditRequestMapHelper : IGenerateBulkCreditRequestMapHelper
    {
        ...
        public DipsNabChq CreateNewDipsNabChq(
            ...
            string alt_trancode,
            bool creditNoteFlag,
            int maxDebitVouchers,
            string customerLinkNumber,
            bool isGeneratedBulkCredit,
            ...
            )
        {
            ...
            var output = new DipsNabChq
            {
                ...
                maxVouchers=RequestHelper.ConvertintvalueToString(maxDebitVouchers),
                customerLinkNumber = customerLinkNumber,
                isGeneratedBulkCredit=RequestHelper.ConvertBoolToIntString(isGeneratedBulkCredit),
