...
{
    public class GenerateCorrespondingVoucherRequestToDipsNabChqScanPodMapper : IMapper<GenerateCorrespondingVoucherRequest, IEnumerable<DipsNabChq>>
    {
        private readonly IGenerateCorrespondingVoucherRequestMapHelper generateCorrespondingVoucherRequestMapHelper;

        public GenerateCorrespondingVoucherRequestToDipsNabChqScanPodMapper(
