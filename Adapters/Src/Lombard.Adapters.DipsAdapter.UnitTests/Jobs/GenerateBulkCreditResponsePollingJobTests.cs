...
{
    [TestClass]
    public class GenerateBulkCreditResponsePollingJobTests
    {
        private Mock<ILifetimeScope> lifetimeScope;
        private Mock<IDipsDbContext> dipsDbContext;
        private Mock<IExchangePublisher<GenerateBatchBulkCreditResponse>> exchangePublisher;
        ...
        public void TestInitialize()
        {
            ...
            exchangePublisher = new Mock<IExchangePublisher<GenerateBatchBulkCreditResponse>>();
        ...
        [TestMethod]
        public void GenerateBulkCredit_WhenExecute_ThenGetCompletedBatches()
        {
        ...
        [TestMethod]
        public void GenerateBulkCredit_WhenExecute_ThenFlagCodelineCorrectionAsCompleted_AndSave()
        {
            queues.Add(GenerateVoucher());
        ...
        [TestMethod]
        public void GenerateBulkCredit_WhenExecute_AndConcurrencyException_ThenRollback()
        {
            queues.Add(GenerateVoucher());
        ...
        [TestMethod]
        public void GenerateBulkCredit_WhenExecute_AndConcurrencyException_ThenLogWarning()
        {
            queues.Add(GenerateVoucher());
        ...
        [TestMethod]
        public void GenerateBulkCredit_WhenExecute_AndGeneralException_ThenLogError()
        {
            queues.Add(GenerateVoucher());
        ...
        private GenerateBulkCreditResponsePollingJob CreatePollingJob()
        {
            return new GenerateBulkCreditResponsePollingJob(lifetimeScope.Object, exchangePublisher.Object, adapterConfiguration.Object, dipsDbContext.Object);
        }
