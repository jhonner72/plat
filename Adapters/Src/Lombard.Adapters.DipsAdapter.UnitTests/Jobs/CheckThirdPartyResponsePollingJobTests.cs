...
{
    [TestClass]
    public class CheckThirdPartyResponsePollingJobTests
    {
        private Mock<ILifetimeScope> lifetimeScope;
        private Mock<IDipsDbContext> dipsDbContext;
        private Mock<IExchangePublisher<CheckThirdPartyBatchResponse>> exchangePublisher;
        ...
        [TestMethod]
        public void CheckThirdParty_WhenExecute_AndConcurrencyException_ThenRollback()
        {
            queues.Add(GenerateVoucher());
        ...
        [TestMethod]
        public void CheckThirdParty_WhenExecute_AndGeneralException_ThenLogError()
        {
            queues.Add(GenerateVoucher());
        ...
        private CheckThirdPartyResponsePollingJob CreatePollingJob()
        {
            return new CheckThirdPartyResponsePollingJob(lifetimeScope.Object, exchangePublisher.Object, adapterConfiguration.Object, dipsDbContext.Object);
        }
