...
{
    [TestClass]
    public class CorrectCodelineResponsePollingJobTests
    {
        private Mock<ILifetimeScope> lifetimeScope;
        private Mock<IDipsDbContext> dipsDbContext;
        private Mock<IExchangePublisher<CorrectBatchCodelineResponse>> exchangePublisher;
        ...
        public void TestInitialize()
        {
            ...
            exchangePublisher = new Mock<IExchangePublisher<CorrectBatchCodelineResponse>>();
        ...
        [TestMethod]
        public void WhenExecute_ThenFlagCodelineCorrectionAsCompleted_AndSave()
        {
            queues.Add(new DipsQueue
            {
                ResponseCompleted = false,
        ...
        private CorrectCodelineResponsePollingJob CreatePollingJob()
        {
            return new CorrectCodelineResponsePollingJob(lifetimeScope.Object, exchangePublisher.Object, adapterConfiguration.Object, dipsDbContext.Object);
        }
