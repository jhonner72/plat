...
{
    [TestClass]
    public class ValidateBatchCodelineRequestMapper
    {
        ...
        public void WhenMapQueue_ThenReturnList()
        {
            ...
            var actual = sut.Map(sampleValidateBatchCodelineRequest);
        ...
        private ValidateBatchCodelineRequestToDipsQueueMapper CreateDipsQueueMapper()
        {
            return new ValidateBatchCodelineRequestToDipsQueueMapper(dipsBatchMapHelper);
        }

        private ValidateBatchCodelineRequestToDipsDbIndexMapper CreateDipsDbIndexMapper()
        {
            return new ValidateBatchCodelineRequestToDipsDbIndexMapper(dipsBatchMapHelper);
        }

        private ValidateBatchCodelineRequestToDipsNabChqScanPodMapper CreateDipsNabChqScanPodMapper()
        {
            return new ValidateBatchCodelineRequestToDipsNabChqScanPodMapper(dipsBatchMapHelper);
        }
    }
}