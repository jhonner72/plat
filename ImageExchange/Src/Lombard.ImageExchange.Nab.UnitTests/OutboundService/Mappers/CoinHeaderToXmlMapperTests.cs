...
{
    [TestClass]
    public class CoinHeaderToXmlMapperTests
    {
        private Mock<IMapper<IReadOnlyDictionary<string, string>, IEnumerable<XElement>>> fieldMapper;
        private IMapper<CoinHeader, XElement> mapper;
 
        private readonly Fixture fixture = new Fixture();
        private readonly CoinHeader input;
        ...
        public CoinHeaderToXmlMapperTests()
        {
            fixture.Register(() => new XElement(TestRField));
            input = fixture.Create<CoinHeader>();
        }
        ...
        [TestMethod]
        public void ReturnedElementIsCoinHeader()
        {
            Assert.AreEqual(
                CoinElementConstants.TransactionHeader, result.Name);
        }
