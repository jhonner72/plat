...
public class DocumentumQueryBuilder {
	...
	public static String buildSearchQuery(VoucherInformation voucherInformation) {
	...
	public String buildSearchQuery1(VoucherInformation voucherInformation) throws DfException  {
	    ...
	    try {
		    ...
		    for ( MappingEntry entry : handler.getEntryList()) {
		    	queryBuffer.append(new MappingEntryQueryProcessor().process(voucherInformation, entry));
		    }
		} catch (Exception e) {
