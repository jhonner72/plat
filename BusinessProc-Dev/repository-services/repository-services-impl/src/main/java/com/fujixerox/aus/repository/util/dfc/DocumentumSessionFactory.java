...
public class DocumentumSessionFactory {
    ...
    */
    private IDfSession createSession() throws DfException  {
		...
		cfg.setString("primary_host", repositoryHost);
		cfg.setInt("primary_port", Integer.parseInt(repositoryPort));
		...
		return sMgr.getSession(RepositoryProperties.repository_name);
   }
