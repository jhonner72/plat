...
public class FVVoucherRecordExtractor implements VoucherRecordExtractor {
	...
	public IDfCollection extractRecords(GetVouchersRequest request, IDfSession session) throws NonRetriableException {
		...
		LogUtil.log("FVVoucherRecordExtractor.extractRecords()", LogUtil.DEBUG, null);
     	...
     	try {  	    	
 	    	String queryString = String.format(DocumentumQuery.GET_ALL_OBJECT_ID_QUERY_WITHOUT_TARGET_END_POINTS, 
