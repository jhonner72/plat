 ...
 * 22/07/2015
 */
public class RepositoryServiceSaveAdjustmentLetterIntegrationTest implements AbstractIntegrationTest {
    ...
    public void shouldSaveAdjustmentLetter() throws Exception {		
		...
		ImageHelper.prepare(ctx, ((StoreAdjustmentLettersRequest)request.getAdjustmentLetters().toArray()[0]).getJobIdentifier());
