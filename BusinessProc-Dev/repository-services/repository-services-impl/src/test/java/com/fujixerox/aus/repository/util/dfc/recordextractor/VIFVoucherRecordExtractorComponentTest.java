...
public class VIFVoucherRecordExtractorComponentTest implements AbstractComponentTest {
	...
	public void shouldExtractNullRecords() throws NonRetriableException, DfException {
		...
		VIFVoucherRecordExtractor extractor = new VIFVoucherRecordExtractor();
		extractor.setCountQuery(countQuery);
		List<HashMap> IDfCollection = extractor.extractVIFRecords(request, mock(IDfSession.class));
		assertTrue(IDfCollection.isEmpty());
	...
	public void shouldExtractRecords() throws NonRetriableException, DfException {
		...
		List<HashMap> IDfCollectionList = extractor.extractVIFRecords(request, mock(IDfSession.class));
		
		assertNotNull(IDfCollectionList);
