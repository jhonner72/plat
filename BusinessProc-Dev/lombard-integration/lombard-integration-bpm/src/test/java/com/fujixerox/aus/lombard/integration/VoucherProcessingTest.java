...
public class VoucherProcessingTest extends AbstractBpmnTest
{
    ...
    public void shouldCompleteProcess_whenManualCorrectionIsRequired()
    {
        ...
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey(BUSINESS_PROCESS_DEFN, "bk_42");
        ...
        runtimeService.correlateMessage("lombard.service.outclearings.unpackagevoucher.response", "bk_42");
        runtimeService.correlateMessage("lombard.service.outclearings.recognisecourtesyamount.response", "bk_42");
        runtimeService.correlateMessage("lombard.service.outclearings.validatecodeline.response", "bk_42", validateCodelineVariables);
        runtimeService.correlateMessage("lombard.service.outclearings.correctcodeline.response", "bk_42");
        runtimeService.correlateMessage("lombard.service.outclearings.validatetransaction.response", "bk_42", validateTransactionVariables);
        runtimeService.correlateMessage("lombard.service.outclearings.correcttransaction.response", "bk_42");
        runtimeService.correlateMessage("lombard.service.outclearings.storebatchvoucher.response", "bk_42");
    ...
    public void shouldCompleteProcess_whenTPCRequired_CorrectionIsRequired()
    {
        ...
        runtimeService.correlateMessage("lombard.service.outclearings.correctcodeline.response", "bk_42");
        runtimeService.correlateMessage("lombard.service.outclearings.validatetransaction.response", "bk_42", validateTransactionVariables);
        runtimeService.correlateMessage("lombard.service.outclearings.correcttransaction.response", "bk_42", validateCodelineVariables);
        runtimeService.correlateMessage("lombard.service.outclearings.checkthirdparty.response", "bk_42");
        runtimeService.correlateMessage("lombard.service.outclearings.storebatchvoucher.response", "bk_42");
