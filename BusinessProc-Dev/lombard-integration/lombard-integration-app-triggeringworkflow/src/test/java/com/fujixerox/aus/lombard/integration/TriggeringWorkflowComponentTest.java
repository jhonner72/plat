...
public class TriggeringWorkflowComponentTest extends AbstractComponentTest {

    @Autowired
    @Qualifier("camelContextTriggeringWorkflow")
    protected CamelContext camelContextTriggeringWorkflow;
