...
public class OutclearingsImageExchangeIntegrationTest extends AbstractIntegrationTest{

    @Test
    @Category(AbstractIntegrationTest.class)
    public void shouldOutclearCleanCheque() throws Exception {

        Resource testData = new ClassPathResource("data/outclearings_imageexchange.json");
