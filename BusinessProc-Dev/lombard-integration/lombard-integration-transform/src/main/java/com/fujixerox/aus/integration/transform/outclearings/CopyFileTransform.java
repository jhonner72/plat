 ...
 */
public class CopyFileTransform extends AbstractOutclearingsTransform implements Transformer<CopyFileRequest> {
    ...
    public CopyFileRequest transform(Job job) {
        ...
        dropPathFile.mkdirs();
        File targetFile =  new File(dropPathFile, createImageExchangeFileResponse.getImageExchangeFilename());
