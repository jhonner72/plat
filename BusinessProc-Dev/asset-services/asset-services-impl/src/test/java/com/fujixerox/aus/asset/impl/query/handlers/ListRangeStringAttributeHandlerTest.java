 ...
 */
public class ListRangeStringAttributeHandlerTest {

    protected IAttributeHandler _handler;

    @Before
    public void setUp() throws Exception {
        _handler = new StringListAttributeHandler(true, Arrays.asList("1", "2",
                "3", "4"));
    }

    @Test
    public void testSingleLow() throws Exception {
        assertEquals("c IN ('1','2','3','4')", _handler.getRestriction(null,
                "c", "1", ""));
    }
