...
{
    [CommandLineArguments(Program = "BpmInstanceExtractor", Title = "Bpm History Extractor", Description = "Extract information from Camunda Bpm for Voucher Processing and Image Exchange")]
    public class BpmInstanceExtractorArguments
    {
