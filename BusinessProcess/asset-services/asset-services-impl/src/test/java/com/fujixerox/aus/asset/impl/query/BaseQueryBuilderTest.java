...
public class BaseQueryBuilderTest {
    ...
    public void testProjection() throws Exception {
        ...
        assertEquals(
                "t1.r_creation_date AS attr1, t1.r_object_id AS attr2 FROM dm_document t1",
        ...
        assertEquals(
                "t1.r_creation_date AS attr1, t1.r_object_id AS attr2, t1.\"deleted\" AS attr3 FROM dm_document t1",
                queryBuilder.buildProjection(null, null, false));
    }
    ...
    public void testOrdering() throws Exception {
        ...
        assertEquals("t1.r_creation_date", queryBuilder.buildOrdering(null));
        queryBuilder.addOrdering(_imObjectHandleAttribute.getObjectType(),
                _imObjectHandleAttribute.getName(), true);
        assertEquals("t1.r_creation_date, t1.r_object_id DESC", queryBuilder
                .buildOrdering(null));
    }
    ...
    public void testIntLowHighRestriction() throws Exception {
        ...
        assertEquals("(t1.r_page_cnt >= 1 AND t1.r_page_cnt <= 2)",
    ...
    public void testIntSameRestriction() throws Exception {
        ...
        assertEquals("(t1.r_page_cnt = 1)", queryBuilder.buildRestriction(null));
    }
    ...
    public void testIntLowRestriction() throws Exception {
        ...
        assertEquals("(t1.r_page_cnt >= 1)", queryBuilder
    ...
    public void testHighLowRestriction() throws Exception {
        ...
        assertEquals("(t1.r_page_cnt <= 2)", queryBuilder
                .buildRestriction(null));
    }
    ...
    public void testDateLowHighRestriction() throws Exception {
        ...
        queryBuilder.addRestriction("vol2", "PostingDate", "20150413",
                "20150416");
        assertEquals(
                "(t1.r_creation_date >= DATE('2015/04/13 00:00:00', 'yyyy/mm/dd hh:mi:ss') AND t1.r_creation_date <= DATE('2015/04/16 23:59:59', 'yyyy/mm/dd hh:mi:ss'))",
                queryBuilder.buildRestriction(null));
    }
    ...
    public void testDateLowRestriction() throws Exception {
        ...
        queryBuilder.addRestriction("vol2", "PostingDate", "20150413", "");
        assertEquals(
                "(t1.r_creation_date >= DATE('2015/04/13 00:00:00', 'yyyy/mm/dd hh:mi:ss'))",
                queryBuilder.buildRestriction(null));
    }
    ...
    public void testDateHighRestriction() throws Exception {
        ...
        assertEquals(
                "(t1.r_creation_date <= DATE('2015/04/16 23:59:59', 'yyyy/mm/dd hh:mi:ss'))",
                queryBuilder.buildRestriction(null));
    }
    ...
    public void testEscapeSingleBackSlash() throws Exception {
        ...
        assertEquals("(t1.object_name = '\\')", queryBuilder
                .buildRestriction(null));
    }
    ...
    public void testEscapeSingleWildcard() throws Exception {
        IQueryBuilder queryBuilder = getQueryBuilder();
        queryBuilder.addRestriction("vol2", "Name", "*", "*");
        assertEquals("(t1.object_name LIKE '%' ESCAPE '\\')", queryBuilder
                .buildRestriction(null));
    }
    ...
    public void testEscapedAndNonWildcard() throws Exception {
        ...
        assertEquals("(t1.object_name = '\\a')", queryBuilder
                .buildRestriction(null));
    }
    ...
    public void testSimpleEnum() throws Exception {
        ...
        assertEquals("(t1.dctmEnum1 IN ('2','3'))", queryBuilder
                .buildRestriction(null));
    }
    ...
    public void testSimpleEnumNoHighBoundary() throws Exception {
        ...
        assertEquals("(t1.dctmEnum1 IN ('2','3','4'))", queryBuilder
                .buildRestriction(null));
    }
    ...
    public void testSimpleEnumNoLowBoundary() throws Exception {
        ...
        assertEquals("(t1.dctmEnum1 IN ('1','2','3'))", queryBuilder
                .buildRestriction(null));
    }
    ...
    public void testSimpleEnumNoMatchHighBoundary() throws Exception {
        ...
        assertEquals("(t1.dctmEnum1 IN ('1','2','3','4'))", queryBuilder
                .buildRestriction(null));
    }
    ...
    public void testMutualEnum() throws Exception {
        ...
        assertEquals("(t1.dctmEnum2 IN ('b','c'))", queryBuilder
                .buildRestriction(null));
    }
    ...
    public void testMutualEnumEquals() throws Exception {
        ...
        assertEquals("(t1.dctmEnum2 = 'c')", queryBuilder
                .buildRestriction(null));
    }
