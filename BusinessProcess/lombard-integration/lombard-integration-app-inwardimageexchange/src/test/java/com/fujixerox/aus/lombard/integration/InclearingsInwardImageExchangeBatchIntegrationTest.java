...
public class InclearingsInwardImageExchangeBatchIntegrationTest extends AbstractIntegrationTest{

    @Test
    @Category(AbstractIntegrationTest.class)
    public void shouldProcessVouchers() throws Exception {

        Resource testData = new ClassPathResource("data/inclearings_inwardimageexchange.json");
