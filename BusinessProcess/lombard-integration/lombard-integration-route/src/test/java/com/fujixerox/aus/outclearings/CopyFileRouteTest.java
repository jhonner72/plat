...
//    @Test      //This test is failing in TFS - permission error when copying file
...
//    @Test      //This test is failing in TFS - permission error when copying file
    public void shouldCopyEclFiles() throws Exception {
        String bitLocker = "src/test/resources/data";
        File jobFolder = new File(bitLocker, CORRELATION_ID);
        jobFolder.mkdirs();
        ...
        String sourceDropPath = "src/test/resources/data/dropzone/Outbound/AusPostECL";

        File targetFile = new File(sourceDropPath);
        targetFile.mkdirs();
        ...
        assertThat(targetFile.exists(), is(true));
        assertThat(targetFile.listFiles().length, is(2));
