...
public class UnpackImageExchangeBatchRouteTest {
    ...
    private static final DocumentTypeEnumStore DOCUMENT_TYPE = DocumentTypeEnumStore.DR;
    ...
    public void shouldUnpackImageExchangeFile() throws Exception {
        ...
        ForValueReference forValueReference = new ForValueReference();
        ForValueDetails forValueDetails = new ForValueDetails();
        forValueDetails.setBsb(BSB_NUMBER);
        forValueDetails.setAccountNumber(ACCOUNT_NUMBER);
        forValueDetails.setDocumentType(DOCUMENT_TYPE);
        forValueReference.getForValueDetails().add(forValueDetails);
        ...
        when(metadataStore.getMetadata(ForValueReference.class)).thenReturn(forValueReference);
