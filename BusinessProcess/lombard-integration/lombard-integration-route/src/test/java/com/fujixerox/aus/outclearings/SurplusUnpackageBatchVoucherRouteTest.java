...
public class SurplusUnpackageBatchVoucherRouteTest {
    ...
    public void shouldUnpackageFromFile() throws Exception {
        ...
        /*
         * This has been disabled as it is a fragile test. The problem is that we are testing a route, but is failing because our test data does not match the
         * design. The size check is still included to validate the route, independent to test data which will definitely pop up elsewhere. In this case, the 
         * test data does not accomodate the new creditNoteFlag in it's current form.
         */
