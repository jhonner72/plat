...
public class EndOfDayProcessingTest extends AbstractBpmnTest {
   ...
   //@Test
    ...
    protected void executeProcess(int vifCount, boolean eom) throws ParseException {
        ...
        assertThat(((ReportRequest)jobEod.getActivities().get(0).getRequest()).getEventType(), is(ReportEventTypeEnum.END_OF_DAY));
        ...
        if (eom)
        {
            ...
            assertThat(((ReportRequest)jobEom.getActivities().get(0).getRequest()).getEventType(), is(ReportEventTypeEnum.END_OF_MONTH));
