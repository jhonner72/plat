 ...
 */
public class CopyValueInstructionFileTransform  extends AbstractTransform implements Transformer<CopyFileRequest> {
    ...
    public CopyFileRequest transform(Job job) {
        ...
        dropPathFile.mkdirs();
        File targetFile =  new File(dropPathFile, createValueInstructionFileResponse.getValueInstructionFileFilename()+".part");
