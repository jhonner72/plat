...
public abstract class AbstractTest
{
    ...
    protected ServiceTest loadTestData(Resource testData, String jobIdentifier) throws Exception {
        ...
        json = json.replaceAll("#CHILD_JOB_IDENTIFIER#", jobIdentifier.substring(jobIdentifier.indexOf("-")));
        ...
        json = json.replaceAll("#DATESTR#", new SimpleDateFormat("dd/MM/yyyy").format(new Date()));
        json = json.replaceAll("#TIMINGS#", new SimpleDateFormat("ddMMyyyy HH:mm:ss").format(new Date()));
