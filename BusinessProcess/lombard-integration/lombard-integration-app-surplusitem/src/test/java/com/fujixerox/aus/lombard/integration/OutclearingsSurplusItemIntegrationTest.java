...
public class OutclearingsSurplusItemIntegrationTest extends AbstractIntegrationTest {

    @Test
    @Category(AbstractIntegrationTest.class)
    public void shouldOutclearCleanCheque() throws Exception {
        Resource testData = new ClassPathResource("data/outclearings_surplusitem.json");
