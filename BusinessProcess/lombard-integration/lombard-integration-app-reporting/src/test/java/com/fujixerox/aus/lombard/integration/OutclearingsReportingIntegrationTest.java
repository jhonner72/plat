...
public class OutclearingsReportingIntegrationTest extends AbstractIntegrationTest{

//    @Test
    @Category(AbstractIntegrationTest.class)
    public void shouldProcessCheque() throws Exception {

        Resource testData = new ClassPathResource("data/outclearings_reporting.json");
