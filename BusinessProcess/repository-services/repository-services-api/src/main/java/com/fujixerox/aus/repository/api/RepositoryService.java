...
public interface RepositoryService {
    ...
    public AssociateVouchersResponse saveAndUpdateAssociateVoucher(AssociateVouchersRequest request) throws RetriableException, NonRetriableException;
    
    public GetReceivedFilesResponse queryReceivedFiles(GetReceivedFilesRequest request) throws RetriableException, NonRetriableException;
    
    public CheckDuplicateFileResponse checkDuplicateFile(CheckDuplicateFileRequest request) throws RetriableException, NonRetriableException;
}
