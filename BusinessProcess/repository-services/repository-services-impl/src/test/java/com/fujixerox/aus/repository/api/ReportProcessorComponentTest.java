...
public class ReportProcessorComponentTest implements AbstractComponentTest{
    ...
    public void shouldSaveReport() throws Exception {
        ...
        when(fileUtil.getFile(any(String.class), any(String.class))).thenReturn(file);
...
//       processor.saveReport(C.JOB_IDENTIFIER_REPORT, mock(IDfSession.class), storeRepositoryReportsRequest);
    ...
    public void shouldSaveAdjustmentLetterReport() throws Exception {
        ...
        FileUtil fileUtil = mock(FileUtil.class);
        File zipFile = new File("C:/Temp/text.2");
        when(fileUtil.getFile(any(String.class), any(String.class))).thenReturn(zipFile);
        ...
        batchRequest.setJobIdentifier("INIT_JOBID/JOB_ID");
        batchRequest.setProcessingDate(processingDate);
        batchRequest.setZipFilename("text.2");
        
        processor.saveAdjustmentLetterReport(session, batchRequest);
