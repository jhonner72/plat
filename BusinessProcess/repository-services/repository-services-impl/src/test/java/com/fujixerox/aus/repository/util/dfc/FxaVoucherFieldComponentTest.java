...
public class FxaVoucherFieldComponentTest implements AbstractComponentTest {
    ...
    public void shouldHaveValues() throws DfException, ACLException, NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException {	
		
		FxaVoucherField fxaVoucherField = new FxaVoucherField();
		
		assertNotNull(FxaVoucherField.class.getDeclaredField("OBJECT_ID").getName());
