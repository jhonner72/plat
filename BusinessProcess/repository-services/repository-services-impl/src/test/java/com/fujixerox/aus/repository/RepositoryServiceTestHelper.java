...
public class RepositoryServiceTestHelper {
	...
	private static List<VoucherAudit> getVoucherAuditList() {
		...
		voucherBsb.setPreValue("9999");
		voucherBsb.setPostValue("9999");
		...
		voucherTc.setPreValue("09");
		voucherTc.setPostValue("08");
		voucherAudits.add(voucherTc);

		VoucherAudit voucherFV = new VoucherAudit();
		voucherFV.setAttributeName("for_value_indicator");
		voucherFV.setSubjectArea("cdc");
		voucherFV.setPostValue(null);
		voucherAudits.add(voucherFV);
		...
		voucherAuditTimin.setPreValue("09092015 15:05:22");
		voucherAuditTimin.setPostValue("09082015 15:05:22");
		...
		voucherBsb1.setPreValue("2345");
		voucherBsb1.setPostValue("6789");
	...
	public static Voucher buildVoucher(String accountNumber, String amount, String bsbNumber, 
		...
		voucher.setTransactionCode("TES");
	...
	private static VoucherProcess buildVoucherProcess(boolean unprocessable,
        ...
        voucherProcess.setDocumentRetrievalDate(new Date());
        voucherProcess.setDocumentRetrievalFlag(true);
...
/*	public static void compareImageExchangeVoucher(ImageExchangeVoucher ieVoucher) {
	...
	public static Criteria buildCriteria(String name, String value) {
	...
	public static StoreVoucher buildStoreVoucherForLockedBox(String accountNumber, String amount, String bsbNumber,
															 String documentReferenceNumber, String processingDate, boolean unprocessable, String docType, String auxDom,
															 String targetEndPoint, String tranLinkNo, String listingPageNUmber, boolean isHighValueFlag) throws ParseException {
		...
		VoucherBatch voucherBatch = buildLockedBoxVoucherBatch();
	...
	private static VoucherBatch buildLockedBoxVoucherBatch() {
		VoucherBatch voucherBatch = new VoucherBatch();

		voucherBatch.setBatchAccountNumber("234567");
		voucherBatch.setBatchType("LCG1");
		voucherBatch.setCaptureBsb("456544");
		voucherBatch.setClient("NAB");
		voucherBatch.setCollectingBank("333222");
		voucherBatch.setProcessingState(StateEnum.NSW);
		voucherBatch.setScannedBatchNumber("343434");
		voucherBatch.setSource("WestPC");
		voucherBatch.setSubBatchType(Constant.PaymentType.REMITTANCEONLY);
		voucherBatch.setUnitID("5434565");
		voucherBatch.setWorkType(WorkTypeEnum.NABCHQ_LBOX);

		return voucherBatch;
	}

	public static StoreBatchVoucherRequest buildStoreBatchVoucherRequestForLockedBox(String batchNumber,
																					 String jobIdentifier, String processingDate, boolean unprocessable) throws ParseException {

		StoreBatchVoucherRequest request = new StoreBatchVoucherRequest();

		request.setVoucherBatch(buildLockedBoxVoucherBatch());
		request.setJobIdentifier(jobIdentifier);
