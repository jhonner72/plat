 ...
 *
 */
public class CustomerLinkVoucherRecordExtractor extends GroupVoucherRecordExtractor {
	
	@Override
	public boolean skipGroup(IDfCollection collection) throws DfException {
		String customerLinkNo = collection.getString(FxaVoucherField.CUSTOMER_LINK_NO);
		if (customerLinkNo == null || customerLinkNo.equals("")) {
			return true;
		}
		return false;
	}
	...
	public String buildCountQueryString(GetVouchersRequest request) {		
		String queryPrefix = "SELECT fxa_voucher.fxa_customer_link_no, "
		...
		String querySuffix = "GROUP BY fxa_voucher.fxa_customer_link_no, fxa_voucher.fxa_processing_date "
				+ "ORDER BY fxa_voucher.fxa_customer_link_no, fxa_voucher.fxa_processing_date";
	...
	public QueryGroupFieldHolder buildQueryGroupFieldHolder(GetVouchersRequest request, IDfCollection collection) throws DfException {
		...
		return new QueryGroupFieldHolder(customerLinkNo, processingDate);
	}
